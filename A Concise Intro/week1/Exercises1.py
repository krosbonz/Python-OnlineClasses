...
def areatriangle(b,h):
    """Computes the area of a triangle given height and base"""
    area=.5*b*h
...
def celcius_to_fahrenheit(temp):
    """ Converts Celcius temperature to Farenheit. Formula is 5/9 of temp minus
    32 """
    newTemp = (9/5)*temp+32
...
def absolutevalue(num):
    if num > 0:
        ...
        math = num*-1
        print("The absolute value of",num,"is", math)
    elif num == 0:
